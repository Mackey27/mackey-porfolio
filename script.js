...
const iconSVGs = {
  ...
  vite: `<svg class="w-8 h-8" viewBox="0 0 24 24" fill="currentColor"><path d="M23.5 3.2L12.5 23.3a.9.9 0 0 1-1.6 0L.5 3.2a.9.9 0 0 1 .9-1.3l10.6 1.9a.9.9 0 0 0 .3 0l10.3-1.9a.9.9 0 0 1 .9 1.3zM12 7.1L8.9 13h2.4l-1 3.8 4.7-7.1h-2.5L14 7.1H12z"/></svg>`,
